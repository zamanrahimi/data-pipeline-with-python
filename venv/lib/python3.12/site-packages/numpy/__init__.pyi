...
_ArrayComplex_co = NDArray[
    np.bool | integer[Any] | floating[Any] | complexfloating[Any, Any]
]
...
class ndarray(_ArrayOrScalarCommon, Generic[_ShapeType, _DType_co]):
    ...
    @overload
    def __iadd__(
        self: NDArray[unsignedinteger[_NBit1]], other: _ArrayLikeUInt_co | _IntLike_co
...
class ndenumerate(Generic[_ScalarType]):
    ...
    @overload
    def __new__(
        cls, arr: builtins.bool | _NestedSequence[builtins.bool]
    ) -> ndenumerate[np.bool]: ...
    @overload
